...
The linearity condition is satisfied (see Appendix). There is not an obvious non-linear relationship between the empirical logit and the predictor variable of `Above Ground Sighter Measurement`.
